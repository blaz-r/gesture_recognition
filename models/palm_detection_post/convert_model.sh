...
# This is modified script from https://github.com/geaxgx/depthai_hand_tracker/tree/main/custom_models
# adjusted to model in this project
...
usage ()
{
        ...
        echo
        echo "model: an existing .onnx file (default=palm_detection_post.onnx)"
        echo "nb_shaves: integer between 1 and 13 (default=2)"
}
...
if [ -z "$model_onnx" ]
then
       model_onnx=palm_detection_post.onnx
fi
if [ ! -f $model_onnx ]
then
